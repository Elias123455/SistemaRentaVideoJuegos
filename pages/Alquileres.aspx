        ...
        <div class="tarjeta-blanca">
            ...
            <asp:GridView ID="gvAlquileres" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="idVideojuego" HeaderText="Juego" />
                    ...
                    <asp:TemplateField HeaderText="Acciones">
                        <ItemTemplate>
                            <a href='ModificarAlquiler.aspx?id=<%# Eval("idAlquiler") %>' style="color: blue; font-weight: bold; text-decoration: underline;">
                                Editar
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
